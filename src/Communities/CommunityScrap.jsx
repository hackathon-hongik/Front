...
export function CommunityScrap(){
    ...
    const handleItemClick = (path) => {
      ...
      const fetchShortData=async()=>{
        try{
            const response=await axiosInstance.get(`/community/${memberId}/clippings/short`);
      ...
      const fetchLongData=async()=>{
        try{
            const response=await axiosInstance.get(`/community/${memberId}/clippings/long/`);
    ...
    return(
        <CommunityPage>
            ...
            <TabsContainer>
                <Tab active={activeTab === 'simple'} onClick={() => setActiveTab('simple')}>책 속 한 줄</Tab>
