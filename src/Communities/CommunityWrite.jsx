...
const short = [
    {
        id: 1,
        short_comment: "1안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요",
        nickname:"롯데 우승은 언제쯤",
        like_count:200,
        book_title:"해리포터",
        book_author:"롤링",
...
export function CommunityWrite(){
    ...
    const handleItemClick=(path,token,isbn)=>{
      ...
      const fetchShortData=async()=>{
        try{
            const response=await axiosInstance.get(`/community/${memberId}/short`);
      ...
      const fetchLongData=async()=>{
        try{
            const response=await axiosInstance.get(`/community/${memberId}/long`);
